        ...
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen">
          ...
          >
            ...
            <p className="mb-6 ">
              ...
              em infraestrutura e desenvolvimento de aplicativos web usando
              JavaScript. Sou uma pessoa extrovertida que aprecia viajar e
              capturar momentos de paisagens magníficas através de fotografias.
              Tenho um autêntico gosto por me envolver em projetos e executá-los
              com excelência, garantindo que cada trabalho seja feito de forma
              impecável.
            </p>
